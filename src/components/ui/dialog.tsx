...
>(({ className, children, closeIconOnClick, hideCloseIcon, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed justify-center items-center m-auto top-0 right-0 bottom-0 left-0 z-50 max-h-[80vh] md:w-[580px] border bg-background shadow-lg",
        className
      )}
      {...props}
    >
